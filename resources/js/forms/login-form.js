...
<form id="login-form" class="space-y-4" novalidate>
  ...
  <div class="flex flex-col">
    <div class="flex justify-between items-center mb-1">
      ...
      <a href="javascript:" id="forgot-password-link" class="hidden text-xs font-bold text-primary-600 hover:text-primary-700 dark:text-primary-400 transition-colors">
        Forgot password?
      </a>
    </div>
